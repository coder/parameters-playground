...
>(({ className, inset, children, ...props }, ref) => (
	<DropdownMenuPrimitive.SubTrigger
		...
		className={cn(
			[
				"flex cursor-default select-none items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-none focus:bg-surface-secondary",
...
>(({ className, inset, ...props }, ref) => (
	<DropdownMenuPrimitive.Item
		...
		className={cn(
			[
				"relative flex cursor-default select-none items-center gap-2 rounded-sm px-2 py-2 font-medium text-content-secondary text-sm outline-none transition-colors",
...
>(({ className, inset, ...props }, ref) => (
	<DropdownMenuPrimitive.Label
		ref={ref}
		className={cn(
			["px-2 py-1.5 font-semibold text-sm", inset && "pl-8"],
			className,
		)}
		{...props}
	/>
