			...
			>
								...
								return (
									...
									>
										...
										<button
											...
											className={cn(
												"ml-1 cursor-pointer rounded-sm border-none bg-transparent pr-0 outline-none focus:ml-2.5 focus:pl-0 focus:ring-2 focus:ring-content-link",
										...
										>
											<X className="h-4 w-4 align-text-bottom text-content-secondary hover:text-content-primary" />
										</button>
									</Badge>
								);
							})}
				...
				<div className="relative">
					{open && (
						<CommandList
							className={
								"absolute top-1 z-10 w-full animate-in rounded-md border border-border border-solid bg-surface-primary text-content-primary shadow-md outline-none"
							}
							onPointerLeave={() => {
