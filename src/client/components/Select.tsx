...
>(({ className, children, id, ...props }, ref) => (
	<SelectPrimitive.Trigger
		...
		id={id}
		className={cn(
			"flex h-10 w-full items-center justify-between whitespace-nowrap rounded-md border border-border border-solid bg-transparent px-3 py-2 font-medium text-content-secondary text-sm shadow-sm ring-offset-background placeholder:text-content-secondary focus:outline-none, focus:ring-2 focus:ring-content-link focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-content-link disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
			className,
		)}
		{...props}
	>
...
>(({ className, children, ...props }, ref) => (
	<SelectPrimitive.Item
		...
		className={cn(
			...
			"pr-8 pl-2 text-content-secondary text-sm outline-none focus:bg-surface-secondary ",
